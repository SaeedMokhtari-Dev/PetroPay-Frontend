                        ...
                        <ProtectedRoute path={Routes.app} allRoles={true}>
                            <Page>
                                <Switch>
                                    ...
                                    <Route exact roles={[RoleType.admin]} path={Routes.addEmployee} component={EditEmployee} />
                                    <Route exact roles={[RoleType.admin]} path={Routes.editEmployee} component={EditEmployee} />
                                    <Route exact roles={[RoleType.admin]} path={Routes.employeeMenu} component={EmployeeMenuEdit} />
                                    ...
                                    <Route exact roles={[RoleType.customer]} path={Routes.companyBranchStatement} component={CompanyBranchStatementList} />
                                    ...
                                    <Route exact roles={[RoleType.admin]} path={Routes.newCustomer} component={NewCustomersList} />
                                    <Route exact roles={[RoleType.admin]} path={Routes.editNewCustomer} component={EditNewCustomer} />
